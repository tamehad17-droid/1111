...
const WithdrawalLimits = ({ userLevel = 1, totalWithdrawn = 0 }) => {
  const levelLimits = {
    1: { daily: 100, monthly: 1000, annual: 10000 },
    2: { daily: 500, monthly: 5000, annual: 50000 },
    3: { daily: 1000, monthly: 10000, annual: 100000 },
    4: { daily: 2500, monthly: 25000, annual: 250000 },
    5: { daily: 5000, monthly: 50000, annual: 500000 }
  };

  const currentLimits = levelLimits?.[userLevel] || levelLimits?.[1];
